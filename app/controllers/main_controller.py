...
class MainController:
    ...
    def open_movie(self, index):
        def open_vlc():
            selected_size = self.size_var_list[index].get()
            movie_link = self.movie_links_list[index][self.size_options_list[index].index(selected_size)]
    ...
    def _long_operation(self):
        try:
            ...
            self.view.create_size_dropdowns(movies, self.movie_links_list, self.size_var_list, self.size_options_list, self.dropdown_menus)
